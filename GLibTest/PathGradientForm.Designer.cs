namespace GLibTest
{
    partial class PathGradientForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            ClientSize = new Size(778, 778);
            Controls.Add(skglPnl);
            Name = "PathGradientForm";
            Text = "PathGradient";
            Load += PathGradientForm_Load;
            Resize += this.PathGradientForm_Resize;
            ResumeLayout(false);
        }
